...
public:
    ...
    void DONOTTestInitialRelaxation() throw (Exception)
    {
...
//        MAKE_PTR(SidekickForce<2>, p_force);
    ...
    void DONOTTestSidekickWithGlobalExtrinsicPull() throw (Exception)
    {
        // Load simulation
        OffLatticeSimulation<2>* p_simulator
            = CellBasedSimulationArchiver<2, OffLatticeSimulation<2> >::Load("TestSidekick", M_RELAXATION_TIME);
        ...
        MAKE_PTR_ARGS(SidekickBoundaryCondition<2>, p_bc, (&(p_simulator->rGetCellPopulation())));
